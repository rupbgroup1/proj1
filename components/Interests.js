...
const Interest = (props) => {
    ...
    //pass the updated interests selected (array) for multi only when the array change
    useEffect(() => {
    ...
    //checks if the interest is selected on the second time
